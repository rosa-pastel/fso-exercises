...
const App = () => {
  ...
  const updateMostVoted = (pointsUpdated) => {
    pointsUpdated.forEach((anecdoteVote, index) => {
      if (anecdoteVote > mostVotes) {
        setMostVoted(anecdotes[index]);
        setMostVotes(anecdoteVote);
      }
    });
  };
  return (
